...
const AdminUsers = () => {
    ...
    const adminUsersData = [
        { id: 1, name: 'Admin User #001', createdDate: '2024-01-15', status: 'Active' },
        { id: 2, name: 'Admin User #002', createdDate: '2024-01-10', status: 'Active' },
        { id: 3, name: 'Admin User #003', createdDate: '2024-01-08', status: 'Inactive' },
    ]

    return (
        <Fragment>
            <Seo title="Admin Users" />
            <Pageheader title="Settings" subtitle="Admin Users" currentpage="Admin Users" activepage="Admin Users" />
                            ...
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div className="d-flex flex-wrap gap-1">
                                    <SpkButton Buttonvariant="primary" Customclass="btn me-2">
                                        <i className="ri-add-line me-1 fw-medium align-middle"></i>Add Admin User
                                    </SpkButton>
                                </div>
                                ...
                                <SpkTables tableClass="text-nowrap" header={[{ title: 'ID' }, { title: 'Name' }, { title: 'Created Date' }, { title: 'Status' }, { title: 'Actions' }]}>
                                    {adminUsersData.map((user, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <span className={`badge ${user.status === 'Active' ? 'bg-success-transparent' : 'bg-danger-transparent'}`}>
                                                    {user.status}
                                                </span>
                                            </td>
                                            <td>
