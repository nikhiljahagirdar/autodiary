...
const SystemLogs = () => {
    ...
    const systemLogsData = [
        { id: 1, name: 'System Log #001', createdDate: '2024-01-15', status: 'Active' },
        { id: 2, name: 'System Log #002', createdDate: '2024-01-10', status: 'Active' },
        { id: 3, name: 'System Log #003', createdDate: '2024-01-08', status: 'Inactive' },
    ]

    return (
        <Fragment>
            <Seo title="System Logs" />
            <Pageheader title="System & Logs" subtitle="System Logs" currentpage="System Logs" activepage="System Logs" />
                            ...
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div className="d-flex flex-wrap gap-1">
                                    <SpkButton Buttonvariant="primary" Customclass="btn me-2">
                                        <i className="ri-add-line me-1 fw-medium align-middle"></i>Add System Log
                                    </SpkButton>
                                </div>
                                ...
                                <SpkTables tableClass="text-nowrap" header={[{ title: 'ID' }, { title: 'Name' }, { title: 'Created Date' }, { title: 'Status' }, { title: 'Actions' }]}>
                                    {systemLogsData.map((log, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <span className={`badge ${log.status === 'Active' ? 'bg-success-transparent' : 'bg-danger-transparent'}`}>
                                                    {log.status}
                                                </span>
                                            </td>
                                            <td>
