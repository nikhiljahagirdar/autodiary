...
const OtpLogs = () => {
    ...
    const otpLogsData = [
        { id: 1, name: 'OTP Log #001', createdDate: '2024-01-15', status: 'Active' },
        { id: 2, name: 'OTP Log #002', createdDate: '2024-01-10', status: 'Active' },
        { id: 3, name: 'OTP Log #003', createdDate: '2024-01-08', status: 'Inactive' },
    ]

    return (
        <Fragment>
            <Seo title="OTP Logs" />
            <Pageheader title="System & Logs" subtitle="OTP Logs" currentpage="OTP Logs" activepage="OTP Logs" />
                            ...
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div className="d-flex flex-wrap gap-1">
                                    <SpkButton Buttonvariant="primary" Customclass="btn me-2">
                                        <i className="ri-add-line me-1 fw-medium align-middle"></i>Add OTP Log
                                    </SpkButton>
                                </div>
