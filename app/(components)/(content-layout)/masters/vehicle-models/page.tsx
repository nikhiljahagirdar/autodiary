...
const VehicleModels = () => {
    ...
    const modelsData = [
        { id: 1, name: 'Camry', createdDate: '2024-01-15', status: 'Active' },
        { id: 2, name: 'Civic', createdDate: '2024-01-10', status: 'Active' },
        { id: 3, name: 'CBR', createdDate: '2024-01-08', status: 'Inactive' },
    ]
    ...
    return (
        <PageWrapper title="Vehicle Models" breadcrumbs={breadcrumbs}>
                    ...
                    <SpkTables tableClass="text-nowrap" header={[{ title: '#' }, { title: 'Name' }, { title: 'Created Date' }, { title: 'Status' }, { title: 'Actions' }]}>
                        {modelsData.map((model, index) => (
                            <tr key={index}>
                                ...
                                <td>
                                    <span className={`badge ${model.status === 'Active' ? 'bg-success-transparent' : 'bg-danger-transparent'}`}>
                                        {model.status}
                                    </span>
                                </td>
                                <td>
