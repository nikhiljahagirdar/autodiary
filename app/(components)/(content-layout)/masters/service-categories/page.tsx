...
const ServiceCategories = () => {
    ...
    const serviceCategoriesData = [
        { id: 1, name: 'Engine Service', createdDate: '2024-01-15', status: 'Active' },
        { id: 2, name: 'Brake Service', createdDate: '2024-01-10', status: 'Active' },
        { id: 3, name: 'Oil Change', createdDate: '2024-01-08', status: 'Inactive' },
    ]

    return (
        <Fragment>
            <Seo title="Service Categories" />
            <Pageheader title="Admin" subtitle="Masters" currentpage="Service Categories" activepage="Service Categories" />
                            ...
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div className="d-flex flex-wrap gap-1">
                                    <SpkButton Buttonvariant="primary" Customclass="btn me-2">
                                        <i className="ri-add-line me-1 fw-medium align-middle"></i>Add Service Category
                                    </SpkButton>
                                </div>
                                ...
                                <SpkTables tableClass="text-nowrap" header={[{ title: 'ID' }, { title: 'Name' }, { title: 'Created Date' }, { title: 'Status' }, { title: 'Actions' }]}>
                                    {serviceCategoriesData.map((category, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <span className={`badge ${category.status === 'Active' ? 'bg-success-transparent' : 'bg-danger-transparent'}`}>
                                                    {category.status}
                                                </span>
                                            </td>
                                            <td>
