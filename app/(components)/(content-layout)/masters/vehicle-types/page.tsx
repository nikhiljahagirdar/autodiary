...
const VehicleTypes = () => {
    ...
    return (
        <Fragment>
            ...
            <Pageheader title="Admin" subtitle="Masters" currentpage="Vehicle Types" activepage="Vehicle Types" />
                            ...
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div className="d-flex flex-wrap gap-1">
                                    <SpkButton Buttonvariant="primary" Customclass="btn me-2">
                                        <i className="ri-add-line me-1 fw-medium align-middle"></i>Add Vehicle Type
                                    </SpkButton>
                                </div>
