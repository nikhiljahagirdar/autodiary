...
const Users = () => {
  ...
  const usersData = [
    { id: 1, name: "John Doe", createdDate: "2024-01-15", status: "Active" },
    { id: 2, name: "Jane Smith", createdDate: "2024-01-10", status: "Active" },
    { id: 3, name: "Bob Johnson", createdDate: "2024-01-08", status: "Inactive" },
  ];
  ...
  return (
    <PageWrapper title="Users" breadcrumbs={breadcrumbs}>
