...
const DriverInvitation = () => {
    ...
    const invitationsData = [
        { id: 1, name: 'Invitation #001', createdDate: '2024-01-15', status: 'Active' },
        { id: 2, name: 'Invitation #002', createdDate: '2024-01-10', status: 'Active' },
        { id: 3, name: 'Invitation #003', createdDate: '2024-01-08', status: 'Inactive' },
    ]

    return (
        <Fragment>
            <Seo title="Driver Invitation" />
            <Pageheader title="Admin" subtitle="Masters" currentpage="Driver Invitation" activepage="Driver Invitation" />
                            ...
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div className="d-flex flex-wrap gap-1">
                                    <SpkButton Buttonvariant="primary" Customclass="btn me-2">
                                        <i className="ri-add-line me-1 fw-medium align-middle"></i>Add Invitation
                                    </SpkButton>
                                </div>
                                ...
                                <SpkTables tableClass="text-nowrap" header={[{ title: 'ID' }, { title: 'Name' }, { title: 'Created Date' }, { title: 'Status' }, { title: 'Actions' }]}>
                                    {invitationsData.map((invitation, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <span className={`badge ${invitation.status === 'Active' ? 'bg-success-transparent' : 'bg-danger-transparent'}`}>
                                                    {invitation.status}
                                                </span>
                                            </td>
                                            <td>
