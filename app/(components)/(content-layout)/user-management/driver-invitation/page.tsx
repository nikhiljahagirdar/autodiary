...
const DriverInvitation = () => {
  ...
  const invitationsData = [
    { id: 1, name: "Driver Invitation #001", createdDate: "2024-01-15", status: "Active" },
    { id: 2, name: "Driver Invitation #002", createdDate: "2024-01-10", status: "Active" },
    { id: 3, name: "Driver Invitation #003", createdDate: "2024-01-08", status: "Inactive" },
  ];
  ...
  return (
    <PageWrapper title="Driver Invitation" breadcrumbs={breadcrumbs}>
