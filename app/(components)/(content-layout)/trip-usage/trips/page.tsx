...
const Trips = () => {
    ...
    const tripsData = [
        { id: 1, name: 'Trip #001', createdDate: '2024-01-15', status: 'Active' },
        { id: 2, name: 'Trip #002', createdDate: '2024-01-10', status: 'Active' },
        { id: 3, name: 'Trip #003', createdDate: '2024-01-08', status: 'Inactive' },
    ]

    return (
        <Fragment>
            <Seo title="Trips" />
            <Pageheader title="Admin" subtitle="Masters" currentpage="Trips" activepage="Trips" />
                            ...
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div className="d-flex flex-wrap gap-1">
                                    <SpkButton Buttonvariant="primary" Customclass="btn me-2">
                                        <i className="ri-add-line me-1 fw-medium align-middle"></i>Add Trip
                                    </SpkButton>
                                </div>
                                ...
                                <SpkTables tableClass="text-nowrap" header={[{ title: 'ID' }, { title: 'Name' }, { title: 'Created Date' }, { title: 'Status' }, { title: 'Actions' }]}>
                                    {tripsData.map((trip, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <span className={`badge ${trip.status === 'Active' ? 'bg-success-transparent' : 'bg-danger-transparent'}`}>
                                                    {trip.status}
                                                </span>
                                            </td>
                                            <td>
