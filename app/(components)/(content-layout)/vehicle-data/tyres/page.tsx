...
const Tyres = () => {
  ...
  const tyresData = [
    { id: 1, user: "John Doe", vehicle: "Toyota Camry", date: "2024-01-15", odometer: 50000, status: "Active" },
    { id: 2, user: "Jane Smith", vehicle: "Honda Civic", date: "2024-01-10", odometer: 30000, status: "Active" },
    { id: 3, user: "Peter Jones", vehicle: "Ford F-150", date: "2024-01-08", odometer: 75000, status: "Replaced" },
  ];
  ...
  return (
    <PageWrapper title="Tyres" breadcrumbs={breadcrumbs}>
          ...
          >
            {tyresData.map((tyre, index) => (
              <tr key={index}>
                ...
                <td>
                  <span
                    className={`badge ${tyre.status === "Active"
