...
const Documents = () => {
    ...
    const documentsData = [
        { id: 1, name: 'Document #001', createdDate: '2024-01-15', status: 'Active' },
        { id: 2, name: 'Document #002', createdDate: '2024-01-10', status: 'Active' },
        { id: 3, name: 'Document #003', createdDate: '2024-01-08', status: 'Inactive' },
    ]

    return (
        <Fragment>
            <Seo title="Documents" />
            <Pageheader title="Admin" subtitle="Masters" currentpage="Documents" activepage="Documents" />
                            ...
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div className="d-flex flex-wrap gap-1">
                                    <SpkButton Buttonvariant="primary" Customclass="btn me-2">
                                        <i className="ri-add-line me-1 fw-medium align-middle"></i>Add Document
                                    </SpkButton>
                                </div>
