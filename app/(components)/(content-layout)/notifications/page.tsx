...
const Notifications = () => {
    ...
    const notificationsData = [
        { id: 1, name: 'Notification #001', createdDate: '2024-01-15', status: 'Active' },
        { id: 2, name: 'Notification #002', createdDate: '2024-01-10', status: 'Active' },
        { id: 3, name: 'Notification #003', createdDate: '2024-01-08', status: 'Inactive' },
    ]

    return (
        <Fragment>
            <Seo title="Notifications" />
            <Pageheader title="Admin" subtitle="Masters" currentpage="Notifications" activepage="Notifications" />
                            ...
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div className="d-flex flex-wrap gap-1">
                                    <SpkButton Buttonvariant="primary" Customclass="btn me-2">
                                        <i className="ri-add-line me-1 fw-medium align-middle"></i>Add Notification
                                    </SpkButton>
                                </div>
