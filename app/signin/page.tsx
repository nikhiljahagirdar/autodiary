                                ...
                                <Card.Body className="p-5">
                                    ...
                                    <div className="d-grid mb-3">
                                        <SpkButton Customclass="btn btn-white btn-w-lg border d-flex align-items-center justify-content-center flex-fill mb-3">
                                            ...
                                            <span className="lh-1 ms-2 fs-13 text-default fw-medium">Signin with Google</span>
                                        </SpkButton>
                                        <SpkButton Customclass="btn btn-white btn-w-lg border d-flex align-items-center justify-content-center flex-fill">
                                            ...
                                            <span className="lh-1 ms-2 fs-13 text-default fw-medium">Signin with Facebook</span>
                                        </SpkButton>
                                    </div>
                                    <div className="text-center mt-3 fw-medium">
                                        Dont have an account? <Link scroll={false} href="/signup" className="text-primary">Sign Up</Link>
                                    </div>
                                </Card.Body>
                            </Card>
                        </Col>
